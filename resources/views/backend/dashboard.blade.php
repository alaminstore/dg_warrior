                     ...
                     <div class="card-body">
                        <div class="card-item">
                           <div class="card-item-icon card-icon">
                               <button  class="btn" data-toggle="modal" data-target="#totalRevenueDetails" data-toggle="tooltip" data-placement="top" title="Revenue Details">
                               ...
                               <!-- Modal -->
                            <div class="modal fade" id="totalRevenueDetails" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    <h5 class="modal-title font-weight-bold" id="staticBackdropLabel">Revenue Details</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true" style="font-weight: 300;">&times;</span>
                                    </button>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <h5 class="text-center">Each Revenue Details</h5>
                                        <br>
                                        <div class="table-responsive">
                                            <table id="totalRevPortion" class="table table-striped table-bordered text-nowrap">
                                                <thead>
                                                ...
                                                <tbody>
                                                   @foreach ($totalRevenueInfo as $rev)
                                                   <tr class="text-center">
                                                    <td><i class="fa fa-usd" style="color: gold;" aria-hidden="true"></i> {{$rev->withdrawable_added}}</td>
                                                    <td><i class="fa fa-clock-o" aria-hidden="true"></i> {{ \Carbon\Carbon::parse($rev->created_at)->format(' g:i A - jS F, Y') }} </td>
                                                   </tr>
                                                   @endforeach
                                                </tbody>
                                            </table>
               ...
               <div class="col-sm-12 col-md-12 col-lg-12 col-xl-4">
                  <div class="card custom-card">
                     <div class="card-body">
                        <div class="card-item">
                           <div class="card-item-icon card-icon">
                               <button type="button" class="btn" data-toggle="modal" data-target="#salesInfoView">
                               ...
                               <!-- Modal -->
                            <div class="modal fade" id="salesInfoView" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    <h5 class="modal-title font-weight-bold" id="staticBackdropLabel">SALES ACHIEVED Details</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true" style="font-weight: 300;">&times;</span>
                                    </button>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <h5 class="text-center">Each SALES ACHIEVED Details</h5>
                                        <br>
                                        <div class="table-responsive">
                                            <table id="salesInfoAchivedTable" class="table table-striped table-bordered text-nowrap">
                                                <thead>
                                                    <tr class="text-center">
                                                        <th>The User</th>
                                                ...
                                                <tbody>
                                                   @foreach ($salesAchievedInfo as $sales)
                                                   <tr class="text-center">
                                                    <td>{{$sales->getUser->username}}</td>
                                                    <td><i class="fa fa-usd" style="color: gold;" aria-hidden="true"></i> {{$sales->topup_amount}}</td>
                                                    <td><i class="fa fa-clock-o" aria-hidden="true"></i> {{ \Carbon\Carbon::parse($sales->created_at)->format(' g:i A - jS F, Y') }} </td>
                                                   </tr>
                                                   @endforeach
                                                </tbody>
                                            </table>
...
<script>
   ...
   $('#topupMoney').on('submit', function (e) {
    ...
    $(document).ready( function () {
        $(document).on('click', '.revInfoView', function (e) {
            e.preventDefault();
            let scrollToPortion = document.getElementById("example2");
            scrollToPortion.scrollIntoView({behavior:"smooth",block:"start"});
        });
    //Subscribe
