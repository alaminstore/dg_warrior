...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">Active Job from the Job List</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('/') }}">DG Warrior</a></li>
            <li class="breadcrumb-item active" aria-current="page">Waiting Jobs</li>
        </ol>
    </div>
            ...
            <div class="row row-sm">
                <div class="col-lg-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            <div>
                                <h6 class="main-content-label mb-1">Task waiting list</h6>
                                <p class="text-muted card-sub-title">Active the tasks which you want. Just you have to click active button and that's all  </p>
                            </div>
                                ...
                                <table id="example2" class="table table-striped table-bordered text-nowrap" >
                                    ...
                                    <tbody id="BalanceRechange">
                                        ...
                                        @php
                                            ...
                                            $jobVisibility = $list->job_visibility == 1 ? "For Public":"Only for my referral users";
                                        @endphp
